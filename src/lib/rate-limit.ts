...
export const avatarUploadLimiter = createRateLimiter(5, "10 m")
export const passwordChangeLimiter = createRateLimiter(5, "15 m")
export const profileMutationLimiter = createRateLimiter(20, "10 m")
export const analyzeLimiter = createRateLimiter(15, "1 h")
export const analyticsReadLimiter = createRateLimiter(60, "10 m")
