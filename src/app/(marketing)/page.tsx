...
export const metadata: Metadata = {
  ...
  description: "Lex AI reads your contracts, NDAs, and policies in seconds — flagging hidden risks, obligations, and unfair clauses in plain language.",
  alternates: { canonical: "/" },
  openGraph: { title: "Lex AI — AI Legal Document Analyzer", description: "Lex AI reads your contracts, NDAs, and policies in seconds — flagging hidden risks, obligations, and unfair clauses in plain language." },
  twitter: { title: "Lex AI — AI Legal Document Analyzer", description: "Lex AI reads your contracts, NDAs, and policies in seconds — flagging hidden risks, obligations, and unfair clauses in plain language." },
}
import {
  Upload, FileSearch, Shield, FileText, ArrowRight,
  CheckCircle, Brain, AlertTriangle, GitCompare,
